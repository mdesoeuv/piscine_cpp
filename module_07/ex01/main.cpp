...
/*   Updated: 2022/03/31 13:39:58 by mdesoeuv         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	iter(TabInt.data(), TabInt.size(), displayElement);
	std::cout << std::endl;
	...
	::iter(TabFloat.data(), TabFloat.size(), displayElement);
	std::cout << std::endl;
	
	TabStr.push_back("bonjour");
	TabStr.push_back("au revoir");
	
	iter(TabStr.data(), TabStr.size(), displayElement);

	return (0);
}

/*
**	correction sheet's main
*/
